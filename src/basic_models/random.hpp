...
{
    std::uniform_int_distribution<u32> uni_dis = std::uniform_int_distribution<u32>(0, maxi - 1);
    return uni_dis(generator);
}
inline int get_random(int maxi)
{
    std::uniform_int_distribution<int> uni_dis = std::uniform_int_distribution<int>(0, maxi - 1);
    return uni_dis(generator);
}
inline size_t get_random(size_t maxi)
{
    std::uniform_int_distribution<size_t> uni_dis = std::uniform_int_distribution<size_t>(0, maxi - 1);
    return uni_dis(generator);
}
...
template <typename T> T get_possi_random(const std::vector<std::pair<T, float>> &vec)
{
    std::uniform_real_distribution<float> uni_dis = std::uniform_real_distribution<float>(0, 1);
...
template <typename T> size_t get_possi_random_(const std::vector<std::pair<T, float>> &vec)
{
    std::uniform_real_distribution<float> uni_dis = std::uniform_real_distribution<float>(0, 1);
    float prob = uni_dis(generator);
